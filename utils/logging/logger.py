...
def setup_log(
    ...
    if alert_to:
        root.addHandler(_get_smtp_handler(app, environment, _append_domain(alert_to), alert_minimum_level))


def _append_domain(comma_separated_emails: str):
...
def _get_smtp_handler(app: str, environment: str, alert_to: str, alert_minimum_level: int):
